...
export function BeforeAfterSlider({
  ...
  return (
    <div className="space-y-3">
      {title && (
        <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1 border-b border-border/40 pb-2">
          <h4 className="title-card text-lg text-ivory">{title}</h4>
